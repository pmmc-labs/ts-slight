...
(run-tests (list
    ...
    (is 30 (length (range 1 30 1)) "... these are all 30")
    (is 30 (+ (length (range 1 10 1)) (length (range 1 (* 4 5) 1))) "... these are all 30")
    (is 30 (+ (product (list 2 1 5)) (sum (list 2 4 6 8))) "... these are all 30")
    (is 30 (sum (list 4 (fib 8) (- (fact 3) 1))) "... these are all 30")
    (is 30 (+ (sum (range 0 (fib 6) 1)) (- 2 8)) "... these are all 30")
